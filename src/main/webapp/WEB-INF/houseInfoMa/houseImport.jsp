	...
	<form id="queryForm">
		<ul class="search-group" style="margin-bottom: 15px">
			...
			<li style="width: 320px">
				<select class="easyui-combobox" id="type" data-options="label:'导入类型',panelHeight:'auto',panelMaxHeight:'400',editable:false,
                ...
                for (var i = 0;i<data.length;i++) {
                    if(data[i].inputflag == 1 || ((data[i].inputflag == 1 )&& (data[i].rationflag == 1))){
                        $('.houseContainer').append(' <li class="houseItem nocheck">' +
                            '<p class="housecheck"><input type="checkbox" name="selectRoom"><span>'+data[i].fylxname+'</span>' +
