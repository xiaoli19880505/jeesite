        ...
        <div class="easyui-panel windowPanel">
            ...
            <form method="post" id="form" class="easyui-form">
                <ul class="search-group-add windowInner">
                    ...
                    <li style="width: 380px"><input class="easyui-textbox" name="doc" style="width: 92%" data-options="label:'资料名称:',required:true,validType:['empty']"></li>
                    <li style="width: 380px"><input class="easyui-textbox" name="area" style="width: 92%" data-options="label:'办理业务地点:',required:true,validType:['empty']"></li>
