	...
	<div class="easyui-panel windowPanel" >
		...
		<form class="easyui-form" method="post" id="changeForm">
			<ul class="search-group-add windowInner">
				...
				<li style="width: 380px"><input class="easyui-textbox" name="meUrl"  style="width: 92%" data-options="label:'<i style=\'color:red;margin-left:0\'>* </i>链接地址:',required:true,validType:['empty']"></li>
