            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <select class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk" style="width: 92%" data-options="label:'婚姻状况:',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=07',
...
<script>
    ...
    var i = 0,j=0,currentIndex=0 ,sucIndex=0,num ="",codeArray=[],nameArray=[];
    var changeImg='';
    ...
    function addPerson() {
        if (person) {
            ...
            var personString = $('<ul class="input-group windowInner">' +
                ...
                '</li>' +
                '<li class="readonly">' +
                '<input class="easyui-datebox" name="applyFamilyMembers[' + i + '].afmCsny" id="applyFamilyMembers' + i + 'afmCsny" style="width: 92%" data-options="label:\'出生年月:\',required:true,editable:false">' +
                '</li>' +
                '<li class="readonly">' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + i + '].afmNsr" id="applyFamilyMembers' + i + 'afmNsr" style="width: 92%" data-options="label:\'年收入:\',required:true,validType:\'number\',events:{keyup:changeSr}">' +
                '</li>' +
