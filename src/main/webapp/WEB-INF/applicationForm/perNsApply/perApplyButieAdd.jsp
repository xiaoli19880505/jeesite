            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li style="width: 600px;text-align: left" class="butieli">
                            ...
                            <input type="radio" name="apTsjt" value="3" checked data-options="required:true"/><label class="lispan">二级以上下肢重度残疾</label>
                            <span class="lispace"></span>
                            <input type="radio" name="apTsjt" value="4" data-options="required:true"/><label class="lispan">低保家庭</label>
                            <span class="lispace"></span>
                            <input type="radio" name="apTsjt" value="5" data-options="required:true"/><label class="lispan">特困家庭</label>
                            <span class="lispace"></span>
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                ...
                <div style="display: none;">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" style="width: 92%" data-options="label:'原住房地址:',required:true,validType:['empty']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcCqr" style="width: 92%" data-options="label:'原产权人:',required:true,validType:['empty','chinese','specialCharacter']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcJzmj" style="width: 92%" data-options="label:'建筑面积(m²):',required:true,validType:['number','empty']">
                        </li>
                        <li>
                            ...
                            <input class="easyui-datebox" name="applyFamilyHouseChange.afhcBgsj" style="width: 58%"  data-options="required:true,editable:false">
                        </li>
                        <li style="display: none" id="cq">
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcZrbcje" style="width: 92%" data-options="label:'required:true,货币补偿金额(元):',validType:'number'">
...
<script>
    var person=false;
    var i = 0, j=0,sucIndex=0,num = "",currentIndex=0,codeArray=[],nameArray = [];
    var changeImg='';
