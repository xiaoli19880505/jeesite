            ...
            <div id="inner">
                ...
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li style="width: 600px;text-align: left" class="butieli">
                            ...
                            <input type="radio" name="apTsjt" value="3" /><label class="lispan">二级以上下肢重度残疾</label>
                            <span class="lispace"></span>
                            <input type="radio" name="apTsjt" value="4"/><label class="lispan">低保家庭</label>
                            <span class="lispace"></span>
                            <input type="radio" name="apTsjt" value="5"/><label class="lispan">特困家庭</label>
                            <span class="lispace"></span>
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmXm" id="applyFamilyMembers1afmXm" style="width: 92%" data-options="label:'姓名:',required:true,validType:['empty','chinese','specialCharacter'],events:{blur:checkUser}">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmSfzh" id="applyFamilyMembers1afmSfzh" style="width: 92%" data-options="label:'身份证号码:',required:true,validType:['sfz','empty'],events:{blur:checkUser}">
                        </li>
                        <li>
                            <select class="easyui-combobox" name="applyFamilyMembers[1].afmXb" id="applyFamilyMembers1afmXb" style="width: 92%" data-options="label:'性别:',required:true,editable:false,panelHeight:'auto'">
                                <option value="女">女</option>
                                <option value="男">男</option>
                            </select>
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmGzdw" id="applyFamilyMembers1afmGzdw" style="width: 92%" data-options="label:'工作单位:',required:true,prompt:'请输入单位全称'">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmLxdh" id="applyFamilyMembers1afmLxdh" style="width: 92%" data-options="label:'联系电话:',required:true,validType:'phone'">
                        </li>
                        <li class="readonly">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyUnit.tel" id="applyUnittel" style="width:92%" data-options="label:'手机号码',validType:'phone',prompt:'非必填'">
                        </li>
                        <li>
                ...
                <div style="display: none;">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcYzfzl" id="applyFamilyHouseChangeafhcYzfzl" style="width: 92%" data-options="label:'原住房地址:',required:true,validType:['empty']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcCqr" id="applyFamilyHouseChangeafhcCqr" style="width: 92%" data-options="label:'原产权人:',required:true,validType:['empty','chinese','specialCharacter']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcJzmj" id="applyFamilyHouseChangeafhcJzmj" style="width: 92%" data-options="label:'建筑面积（m²）:',required:true,validType:['number','empty']">
                        </li>
                        <li>
                            ...
                            <input class="easyui-datebox" name="applyFamilyHouseChange.afhcBgsj" id="applyFamilyHouseChangeafhcBgsj"  style="width: 58%"  data-options="required:true,editable:false">
                        </li>
                        <li id="cq">
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcZrbcje" id="applyFamilyHouseChangeafhcZrbcje" style="width: 92%" data-options="label:'货币补偿金额(元):',required:true,validType:'number'">
...
<script>
    ...
    function save() {
        ...
        var apTsjt=$.trim($('input[type=radio][name=apTsjt]').val());
        $('#form').form('submit', {
    ...
    function change(){
        ...
        $("#cqaz").show();
        $('#applyFamilyHouseChangeafhcAzfzl,#applyFamilyHouseChangeafhcAzfjzmj').textbox({required:true});
    }
    function changeSecond(){
        $("#cq label").text("转让金额(元):");
        $("#cqaz").hide();
        $('#applyFamilyHouseChangeafhcAzfzl,#applyFamilyHouseChangeafhcAzfjzmj').textbox({required:false});
    }
    //添加家庭成员
    function addPerson() {
        if(person) {
            ...
            var perString = $('<ul class="input-group windowInner">' +
                ...
                '<li>' +
                '<input class="easyui-combobox" name="applyFamilyMembers[' + i + '].afmYsqrgx" style="width: 92%" data-options="label:\'关系:\',valueField:\'piItemname\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/selectGxExceptPeiou\',required:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\'">' +
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + i + '].afmXm" style="width: 92%" data-options="label:\'姓名:\',required:true">' +
                '</li>' +
                '<li>' +
                '<input class="easyui-datebox" name="applyFamilyMembers[' + i + '].afmCsny" style="width: 92%" data-options="label:\'出生年月:\',required:true,editable:false">' +
                '</li>' +
                '<li>' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + i + '].afmGzdw" style="width: 92%" data-options="label:\'工作单位:\',required:true,prompt:\'请输入单位全称\'">' +
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + i + '].afmSfzh" style="width: 92%" data-options="label:\'身份证号码:\',required:true,validType:\'sfz\'">' +
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers[' + i + '].afmNsr" style="width: 92%" data-options="label:\'年收入:\',required:true,validType:\'number\'">' +
                '</li>' +
        ...
        if(data.applyFamilyMembers.length>1){
            for(var i = 2; i< data.applyFamilyMembers.length;i++){
                $('<ul class="input-group windowInner">' +
                    ...
                    '</li>' +
                    '<li>' +
                    '<input class="easyui-textbox" name="applyFamilyMembers['+i+'].afmNsr" id="applyFamilyMembers'+i+'afmNsr" style="width: 92%" data-options="label:\'年收入(元):\',required:true,validType:[\'number\',\'empty\'],events:{keyup:changeSr}">' +
                    '</li>' +
                    '</ul>').appendTo("#addPerson");
