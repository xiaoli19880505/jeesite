            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        <legend>申请人信息</legend>
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmXm" value="${sessionScope.applyUserinfo.username}" style="width: 92%" data-options="label:'姓名:',required:true,readonly:true">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh" value="${sessionScope.applyUserinfo.sfzh}" style="width: 92%" data-options="label:'身份证号码:',required:true,validType:'sfz',readonly:true">
                        </li>
                        <li class="readonly">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <select class="easyui-combobox" name="applyFamilyMembers[1].afmXb" id="applyFamilyMembers1afmXb"  style="width: 92%" data-options="label:'性别:',editable:false,panelHeight:'auto',panelMaxHeight:'280'">
                                <option value="女">女</option>
                                <option value="男">男</option>
                            </select>
                        </li>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfzl" style="width: 92%"
                                   data-options="label:'安置房地址:',required:true">
                        </li>
                        <li>
...
<script>
    var person=false;
    var i = 0, j =0,num = "",sucIndex=0,currentIndex=0,codeArray=[],nameArray = [];
    var changeImg='';
