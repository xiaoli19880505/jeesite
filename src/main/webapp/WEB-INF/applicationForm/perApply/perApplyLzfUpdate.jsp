                ...
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            ...
                            <input type="checkbox" name="apTsjt" value="1" data-options="required:true"/>烈属&nbsp;&nbsp;
                            <input type="checkbox" name="apTsjt" value="2" data-options="required:true"/>残疾人&nbsp;&nbsp;
                            <input type="checkbox" name="apTsjt" value="3" data-options="required:true"/>孤寡老人&nbsp;&nbsp;
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-datebox" name="apFzsj" style="width: 92%"
                                   data-options="label:'低保发证时间',required:true,editable:false">
                        </li>
                    </ul>
                    <p class="sbumit right">
                        <span><a href="#">下一步</a></span>
...
<script>
    ...
    function save() {
        ...
        //是否特殊家庭处理
        $('input[type=checkbox][name=apTsjt]').each(function() {
            if($(this).is(':checked')){
