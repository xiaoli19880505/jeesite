                ...
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li style="width: 600px;text-align: left" class="butieli">
                            ...
                            <input type="radio" name="abTsjt" value="3" data-options="required:true"/><label class="lispan">二级以上下肢重度残疾</label>
                            <span class="lispace"></span>
                            <input type="radio" name="abTsjt" value="4" data-options="required:true"/><label class="lispan">低保家庭</label>
                            <span class="lispace"></span>
                            <input type="radio" name="abTsjt" value="5" data-options="required:true"/><label class="lispan">特困家庭</label>
                            <span class="lispace"></span>
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
...
<script>
    ...
    function save() {
        ...
        var abTsjt=$.trim($('input[type=radio][name=abTsjt]').val());
        $('#form').form('submit', {
    ...
    function addPerson() {
        if(person){
            ...
            var perString= $('<ul class="input-group windowInner">' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-combobox" name="applyFamilyMembers['+ i +'].afmHyzk" id="applyFamilyMembers'+ i +'afmHyzk" style="width: 92%" data-options="label:\'婚姻状况:\',valueField:\'piItemcode\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/getOptions?parmSetcode=07\',required:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\'">' +
                '</li>' +
                '<li>' +
