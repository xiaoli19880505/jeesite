            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            ...
                            url:'<%=basePath %>ParmItem/getOptions?parmSetcode=07',editable:false,onSelect:selectHY">
                            </select>
                        </li>
                        <li class="readonly">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-datebox" name="affLdhtkssj" style="width: 92%" data-options="label:'劳动合同签订年限(年):',required:true,editable:false,validType:['minDate']">
                        </li>
                        <li>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyUnit.entag" id="applyUnitentag" style="width:92%" data-options="label:'委托代理人',required:true,validType:['empty','chinese','specialCharacter']">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyUnit.tel" id="applyUnittel" style="width:92%" data-options="label:'手机号码',required:true,validType:['numberZ','empty']">
                        </li>
                        <li>
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="affJtnsr" id="affJtnsr" style="width: 92%" data-options="label:'家庭年收入(元):',required:true,validType:'number'">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="affRjysr" id="affRjysr" style="width: 92%" data-options="label:'人均月收入(元):',required:true,validType:'number'">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
...
<script>
    var person=false;
    var j=0,currentIndex=0,sucIndex=0,num = "",nameArray=[],codeArray=[],initArray=[];
    var changeImg='';
    ...
    function addPerson() {
        ...
        if(person){
            ...
            var perString=$('<ul class="input-group windowInner">' +
                ...
                '</li>' +
                '<li>' +
                '<input class="easyui-textbox" name="applyFamilyMembers['+i+'].afmNsr" id="applyFamilyMembers'+i+'afmNsr" style="width: 92%" value="0" data-options="label:\'年收入(元):\',required:true,validType:\'number\',events:{keyup:changeSr}">' +
                '</li>' +
        ...
        if(data.applyFamilyMembers.length>1){
            for(var i = 1; i< data.applyFamilyMembers.length;i++){
                 $('<ul class="input-group windowInner">' +
                    ...
                    '</li>' +
                    '<li>' +
                    '<input class="easyui-combobox" name="applyFamilyMembers['+i+'].afmYsqrgx" id="applyFamilyMembers'+i+'afmYsqrgx" style="width: 92%" data-options="label:\'关系:\',valueField:\'piItemname\',textField:\'piItemname\',' +
                     'url:\'<%=basePath %>ParmItem/findFamylyOnlypozn\',required:true,editable:false,panelHeight:\'auto\',panelMaxHeight:\'280\',onSelect:selectMemberHy">' +
                    '</li>' +
                    '<li>' +
                    '<input class="easyui-textbox" name="applyFamilyMembers['+i+'].afmXm" id="applyFamilyMembers'+i+'afmXm"  style="width: 92%" data-options="label:\'姓名:\',required:true,validType:[\'empty\',\'chinese\',\'specialCharacter\']">' +
                    '</li>' +
                    ...
                    '</li>' +
                    '<li class="readonly">' +
                    '<input class="easyui-combobox" name="applyFamilyMembers['+i+'].afmHyzk"  id="applyFamilyMembers'+i+'afmHyzk" style="width: 92%" data-options="label:\'婚姻状况:\',valueField:\'piItemcode\',textField:\'piItemname\',url:\'<%=basePath %>ParmItem/getOptions?parmSetcode=07\',required:true,editable:false">' +
                    '</li>' +
                    '<li>' +
