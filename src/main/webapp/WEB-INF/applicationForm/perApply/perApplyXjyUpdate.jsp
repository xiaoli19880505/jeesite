            ...
            <div id="inner">
                <div>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="afgGrnsr" id="applyFamilyMembers0afmNsr" style="width: 92%" data-options="label:'个人年收入(元):',required:true,validType:'number'">
                        </li>
                        <li class="readonly">
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-datebox" name="afgGjjjnsj" style="width: 83%" data-options="label:'住房公积金缴纳情况',required:true,editable:false,validType:['minDate']">
                            &nbsp;至今
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
            ...
            for(var i = 1; i< data.applyFamilyMembers.length;i++){
                 $('<ul class="input-group windowInner">' +
                    ...
                    '</li>' +
                     ...
                     '</li>' +
                    '<li>' +
                    '<input class="easyui-textbox" name="applyFamilyMembers['+i+'].afmNsr" id="applyFamilyMembers'+i+'afmNsr" style="width: 92%" data-options="label:\'年收入(元):\',required:true,validType:\'number\'">' +
                    '</li>' +
                    '</ul>').appendTo("#addPerson");
