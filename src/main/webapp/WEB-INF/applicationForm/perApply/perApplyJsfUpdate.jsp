            ...
            <div id="inner">
                ...
                <div>
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <select class="easyui-combobox" name="applyFamilyMembers[1].afmXb" id="applyFamilyMembers1afmXb" style="width: 92%" data-options="label:'性别:',required:true,editable:false">
                                <option value="女">女</option>
                                <option value="男">男</option>
                            </select>
                        </li>
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmNsr" id="applyFamilyMembers1afmNsr" style="width: 92%" data-options="label:'个人年收入(元):',required:true,validType:['empty','number'],events:{keyup:changeSr}">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>户籍信息</legend>
...
<script>
    var j=0,sucIndex=0,currentIndex=0,num = "",codeArray=[],nameArray=[],initArray=[];
    var changeImg='';
    ...
    function addPerson() {
        ...
        var personString=$('<ul class="input-group windowInner">' +
            ...
            '</li>' +
            '<li>' +
            '<input class="easyui-textbox" name="applyFamilyMembers[' + i + '].afmNsr" id="applyFamilyMembers' + i + 'afmNsr" value="0" style="width: 92%" data-options="label:\'个人年收入(元):\',required:true,validType:[\'number\',\'empty\'],events:{keyup:changeSr}">' +
            '</li>' +
