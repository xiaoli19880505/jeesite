...
<div data-options="region:'center',border:'false'">
    <form class="changeForm" id="changeForm" method="post">
        <div class="formItem">
            <input class="easyui-textbox" id="oldpwd" name="oldpwd" type="password"  style="width: 92%" data-options="label:'<i style=\'color:red\'>* </i>原始密码:',required:true">
        </div>
        <div class="formItem">
            <input class="easyui-textbox" id="newPwd" name="newPwd" type="password"  style="width: 92%" data-options="label:'<i style=\'color:red\'>* </i>新密码:',required:true">
        </div>
        <div class="formItem">
