            ...
            <div id="inner">
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <select class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk" style="width: 92%"
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <select class="easyui-combobox" name="applyFamilyMembers[1].afmXb" style="width: 92%" data-options="label:'性别:',required:true,editable:false,panelHeight:'auto'">
                                <option value="女">女</option>
                                <option value="男">男</option>
                            </select>
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmGzdw" style="width: 92%" data-options="label:'工作单位:',prompt:'请输入单位全称',required:true">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmLxdh" style="width: 92%" data-options="label:'联系电话:',required:true,validType:['phone','empty']">
                        </li>
                        <li class="readonly">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="apJtrk" id="apJtrk" style="width: 92%" value="2" data-options="label:'家庭人口:',required:true,readonly:true,validType:['numberZ','empty']">
                        </li>
                        <li class="readonly">
