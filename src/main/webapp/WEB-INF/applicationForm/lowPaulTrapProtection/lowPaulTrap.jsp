                ...
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li style="width: 600px;text-align: left" class="butieli">
                            ...
                            <input type="radio" name="abTsjt" value="3" /><label class="lispan">二级以上下肢重度残疾</label>
                            <span class="lispace"></span>
                            <input type="radio" name="abTsjt" value="4" /><label class="lispan">低保家庭</label>
                            <span class="lispace"></span>
                            <input type="radio" name="abTsjt" value="5" /><label class="lispan">特困家庭</label>
                            <span class="lispace"></span>
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                        <legend>配偶信息</legend>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmXm" id="applyFamilyMembers1afmXm"  style="width: 92%" data-options="label:'姓名:',validType:['empty','chinese','specialCharacter'],events:{blur:checkUser}">
                        </li>
                        <li>
                            <input class="easyui-textbox" name="applyFamilyMembers[1].afmSfzh" id="applyFamilyMembers1afmSfzh" style="width: 92%" data-options="label:'身份证号码:',validType:['sfz','empty'],events:{blur:checkUser}">
                        </li>
                        <li>
                ...
                <div style="display: none;">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li style="display: none" id="cq">
                            <input class="easyui-textbox" name="applyFamilyHouseChange.afhcZrbcje" style="width: 92%" data-options="label:'货币补偿金额(元):',required:true,validType:'number'">
