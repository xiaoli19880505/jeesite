            ...
            <div id="inner">
                ...
                <div>
                    <ul class="input-group windowInner">
                        ...
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmLxdh" value="${sessionScope.applyUserinfo.linktel}" style="width: 92%" data-options="label:'联系电话:',required:true,readonly:true,validType:'phone'">
                        </li>
                        <li class="readonly">
                            <input class="easyui-textbox" name="applyFamilyMembers[0].afmSfzh"  value="${sessionScope.applyUserinfo.sfzh}" style="width: 92%" data-options="label:'身份证号码:',required:true,readonly:true,validType:['sfz','empty']">
                        </li>
                        <li>
                        ...
                        <li>
                            <input class="easyui-combobox" name="applyFamilyMembers[0].afmHyzk" style="width: 92%"
                               data-options="label:'婚姻状况:',required:true,valueField:'piItemcode',textField:'piItemname',url:'<%=basePath %>ParmItem/getOptions?parmSetcode=07',
                                   editable:false,panelHeight:'auto',panelMaxHeight:'280',onSelect:selectHY">
                        </li>
                    </ul>
                    <ul class="input-group windowInner">
                    ...
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-textbox" name="applyUnit.tel" style="width:92%" data-options="label:'手机号码:',required:true,validType:'phone'">
                        </li>
                        <li>
                ...
                <div style="display: none;">
                    <ul class="input-group windowInner">
                        ...
                        <li>
                            <input class="easyui-datebox" name="afgLdhtjssj" style="width: 92%" data-options="label:'至',required:true,editable:false">
                        </li>
                        <li>
                            <input class="easyui-datebox" name="afgSbjnsj" style="width: 83%" data-options="label:'社会保险缴纳情况:',required:true,editable:false,validType:['minDate']">
                            &nbsp;至今
                        </li>
                        <li>
