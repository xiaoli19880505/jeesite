...
<div data-options="region:'center',border:false">
    <div id="information" class="easyui-panel" title="申请须知" style="width: 100%;overflow: hidden;">
        ...
        <div id="input" style="display: none">
            <div class="beforeRed">
                <span class="name">承诺（申请）人：</span><input type="text" class="write"/>&nbsp;&nbsp;<span class="readagree" onclick="readagree()">我同意，继续申请</span>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    function readagree() {
        var name = $.trim($(".write").val());
        var loginName = '${sessionScope.applyUserinfo.username}';
       if(name == loginName){
            if (num == 5) {
