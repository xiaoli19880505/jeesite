		...
		<div id="loginform" class="form-vertical" onkeydown="checklogin(event)" >
			<form action="<%=basePath %>applyUserinfo/loadMenu" method="post" onsubmit="return doCheck()">
				<div class="userInput">
					...
					<input id="sfzh" name="sfzh"  value="${sfzh}" class="input" type="text" autofocus="autofocus" maxlength="25" style="padding-left: 100px">
				</div>
				<div class="userInput">
					<i class="icon iconfont icon-mima black">&nbsp;&nbsp;密码</i>
					<input id="password" name="userpwd" value="${userpwd}" class="input" type="text" maxlength="25" onkeyUp="lenCheck(this);">
				</div>
				<div class="userInput">
				...
				<div class="button">
					<input type="submit" value="登  录"  class="btn-login" />
					 <p class="forgetp"><a onclick="forgetPwd()" style="color: #3e7cc4;cursor: pointer">忘记密码?</a></p>
				</div>
			</form>
		</div>
	</div>
