...
<div data-options="region:'center',border:'false'">
    <div class="pwdcontainer">
        <div class="pwdTitle">
            <div class="titleItem arrow arrowOne">1.输入登录名</div>
        ...
        <div class="pwdContent">
            <div class="stepOne step">
                <form class="changeForm" id="changeForm" method="post" style="padding-top: 75px;width: 420px" >
                    <div class="formItem">
                        <input class="easyui-textbox"  name="usercode"   style="width: 92%" data-options="label:'<i style=\'color:red\'>* </i>登录名:',required:true,validType:['empty']">
                    </div>
                    <div class="formItem">
            ...
            <div  class="stepTwo step" style="display: none">
                <form class="changeForm" id="confirmForm" method="post" style="padding-top: 75px;width: 420px;" >
                    <div class="formItem readonly">
                        <input class="easyui-textbox" id="usercode" name="usercode" style="width: 92%" data-options="label:'<i style=\'color:red\'>* </i>登录名:',readonly:true">
                    </div>
                    <div class="formItem readonly">
            ...
            <div  class="stepThree step" style="display: none">
                <form class="changeForm" id="pwdForm" method="post" style="padding-top: 75px;width: 420px;" >
                    <div class="formItem readonly">
                        <input class="easyui-textbox" id="username" name="usercode" style="width: 92%" data-options="label:'<i style=\'color:red\'>* </i>登录名:',readonly:true">
                    </div>
                    <div class="formItem">
                        <input class="easyui-textbox" id="newPwd" name="newPwd" type="password"  style="width: 92%" data-options="label:'<i style=\'color:red\'>* </i>新密码:',required:true,validType:['empty']">
                    </div>
                    <div class="formItem">
     ...
     function secondStep(){
        bank.ajaxForm('#confirmForm','<%=basePath %>applyUserinfo/submitCode',{},function(data){
            if(data=="成功"){
                ...
                clearSession();//清空缓存
                $("#username").textbox('setValue',user.usercode);
