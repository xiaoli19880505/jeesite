					...
					<div id="inner">
						<div>
							...
							<ul class="apply-group windowInner">
								<legend>户籍信息</legend>
								<li class="readonly">
									<input class="easyui-textbox" name="apSqhjnx" style="width: 92%" data-options="label:'户籍年限',readonly:true">
								</li>
								<li class="readonly">
	...
	<div class="auditRestlt">
		...
		<ul class="search-group">
			...
			<li class="time" style="display:none;width: 380px">
				<input class="easyui-datebox" id="sqrq" style="width: 92%" data-options="label:'通知签订协议时间',validType:['overDate']">
			</li>
			<li class="doc" style="display:none;width: 380px">
				<input class="easyui-textbox" id="doc" style="width: 92%" data-options="label:'携带资料名称',validType:['empty']">
			</li>
