						...
						<div>
							<ul class="apply-group windowInner">
								...
								<li style="width: 600px;text-align: left" class="butieli">
									...
									<input type="radio" name="abTsjt" value="3" required/><label class="lispan">二级以上下肢重度残疾</label>
							...
							<ul class="apply-group windowInner">
								<legend>户籍信息</legend>
								<li class="readonly">
									<input class="easyui-textbox" name="abSqhjnx" style="width: 92%" data-options="label:'户籍年限',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="abJtnsr" style="width: 92%" data-options="label:'家庭年收入:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="abJtrk" style="width: 92%" data-options="label:'家庭人口:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="abRjysr" style="width: 92%" data-options="label:'人均月收入:',readonly:true">
								</li>
							</ul>
							<ul class="apply-group windowInner">
						...
						<div style="display: none;">
							...
							<ul class="apply-group windowInner">
								...
								<li id="cq" class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouseChange.afhcZrbcje" id="applyFamilyHouseChangeafhcZrbcje" style="width: 92%" data-options="label:'货币补偿金额:',readonly:true">
							...
							<ul class="apply-group windowInner" >
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouseChange.afhcAzfjzmj" id="applyFamilyHouseChangeafhcAzfjzmj" style="width: 92%" data-options="label:'建筑面积:',readonly:true">
								</li>
							</ul>
						</div>
	...
	<div class="auditRestlt">
		...
		<ul class="search-group">
			...
			<li class="time" style="display: none;width: 380px">
				<input class="easyui-datebox" id="sendTime" style="width:92%" data-options="label:'通知签订补贴协议时间',validType:['overDate']">
			</li>
...
<script>
    ...
    $('body').on('change','input[type=radio][name=all]',function(){
        ...
        if(radioId=="1"){
            ...
            //签字插件 展示初始化
			if("${yuanjianFlag}"!="1"){
                bank.showWindow("<%=basePath %>path/toSign","签字",740, 300, true);
            }
