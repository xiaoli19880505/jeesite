					...
					<div id="inner">
						<div>
							...
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="afgSqhjnx" style="width: 92%" data-options="label:'户籍年限:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgJtrks" style="width: 92%" data-options="label:'家庭人口:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgGrnsr" style="width: 92%" data-options="label:'个人年收入:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgJtnsr" style="width: 92%" data-options="label:'家庭年收入:',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-textbox" name="afgRjysr" style="width: 92%" data-options="label:'人均月收入:',readonly:true">
								</li>
							</ul>
							<ul class="apply-group windowInner">
						...
						<div style="display: none;">
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-datebox" name="afgLdhtjssj" style="width: 92%" data-options="label:'至',readonly:true">
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="afgSbjnsj" style="width: 83%" data-options="label:'社会保险缴纳情况',readonly:true">
									&nbsp;至今
								</li>
								<li class="readonly">
									<input class="easyui-datebox" name="afgGjjjnsj" style="width: 83%" data-options="label:'住房公积金缴纳情况',readonly:true">
									&nbsp;至今
								</li>
							</ul>
							<ul class="apply-group windowInner">
								...
								<li class="readonly">
									<input class="easyui-textbox" name="applyFamilyHouses[0].afhMj" id="applyFamilyHouses0afhMj" style="width: 92%" data-options="label:'坐落面积:',readonly:true">
								</li>
								<li class="readonly">
	...
	<div class="auditRestlt">
		...
		<ul class="search-group">
			...
			<li class="time" style="display: none;width: 380px">
				<input class="easyui-datebox" id="sendTime" style="width:92%" data-options="label:'通知复审时间',validType:['overDate']">
			</li>
