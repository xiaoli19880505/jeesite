                    ...
                    <div id="inner">
                        ...
                        <div style="display: none;">
                            <ul class="apply-group windowInner">
                                ...
                                <li class="readonly">
                                    <input class="easyui-textbox" name="affJtnsr" style="width: 92%" data-options="label:'家庭年收入:',readonly:true">
                                </li>
                                <li class="readonly">
                                    <input class="easyui-textbox" name="affRjysr" style="width: 92%" data-options="label:'人均月收入:',readonly:true">
                                </li>
                            </ul>
                            <ul class="apply-group windowInner">
                                ...
                                <li class="readonly">
                                    <input class="easyui-textbox" name="applyFamilyHouse.afhMj" id="applyFamilyHouseafhMj" style="width: 92%" data-options="label:'坐落面积:',readonly:true">
                                </li>
                                <li class="readonly">
                                    <input class="easyui-textbox" name="applyFamilyHouse.afhRjmj" id="applyFamilyHouseafhRjmj"  style="width: 92%" data-options="label:'人均建筑面积:',readonly:true">
                                </li>
                                <li class="readonly">
