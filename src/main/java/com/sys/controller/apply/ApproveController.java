...
public class ApproveController {
    ...
    public Object findApplyForApprove(HttpServletRequest request){
        ...
        PageInfo pageInfo = (PageInfo)appoveService.findApplyForApprove(aptype,aplbh,page,rows);
...
//        }else
    ...
    public Object houseQuitOperate(HttpServletRequest request){
        ...
        int updateCont=appoveService.updatehouseQuitOperate(atype,applyid,sqbh,userInfo.getUserid(),acremark);
        if(updateCont>0){
            result="放弃成功";
        }else{
            result="放弃失败";
    ...
    @ResponseBody
    public Object findNoSign(String ssq,String aptype,HttpServletRequest request){
        String pageStr = request.getParameter("page");
        String rowsStr = request.getParameter("rows");
        String username = request.getParameter("username");
        String sfzh = request.getParameter("sfzh");
        ...
        List<Map> appovePageInfo=appoveService.findNoSign(map);
        Map<String,Object> map2=new HashMap<String, Object>();
        map2.put("rows",appovePageInfo);
        map2.put("total",appoveService.countNoSign(map));
        return map2;
    }
