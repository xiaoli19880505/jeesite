...
//                Integer.parseInt((String) map.get("rows")));
     ...
     * @return
     */
    public Object findApplyForApprove(String aptype,String aplbh,String page,String rows){
...
//        }
     ...
     * @return
     */
    public int updatehouseQuitOperate(String atype,String applyid,String sqbh,String userid,String acRemark){
        //放弃操作跟新申请单状态 zt为5
        try {
