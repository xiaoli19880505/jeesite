...
public class ApplyUserinfo extends DataGridResult implements Serializable {
    private String userid;

    private String usercode;//登陆名
    ...
    private String state;//申请用户状态 0、不可用，1、可用
